    ...
    >
      ...
      >
        <div className="relative flex h-24 w-24 items-center justify-center rounded-3xl border border-border/40 bg-card/60 backdrop-blur-2xl">
          ...
          {/* Outer glow ring */}
          <div className="absolute inset-[-1px] rounded-3xl bg-gradient-to-b from-primary/20 to-transparent opacity-60" style={{ mask: "linear-gradient(black, transparent)", WebkitMask: "linear-gradient(black, transparent)" }} />
        </div>
      </div>
      ...
      >
        ...
        <p className="mt-4 text-center text-xs text-muted-foreground/40">
          Windows 10+ &middot; 45MB &middot; Free
        </p>
      </div>
      ...
      >
        ...
        <ChevronDown className="h-4 w-4 text-muted-foreground/30" style={{ animation: "bounce 2s ease-in-out infinite" }} />
      </div>
    </section>
  )
}
